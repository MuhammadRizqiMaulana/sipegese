                  ...
                  <form enctype="multipart/form-data" class="contact-form-area contact-page-form contact-form text-left" action="AksiEditProfilAdmin{{$datas->id_admin}}" method="post">
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <td><input type="email" class="form-control" name="email" placeholder="kosongkan jika tidak dirubah"></td>
                      </tr>
                    </table>
                    @if ($errors->has('email'))
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <td><input type="number" maxlength="15" class="form-control" name="no_hp" placeholder="kosongkan jika tidak dirubah"></td>
                      </tr>
                    </table>
                    @if ($errors->has('no_hp'))
