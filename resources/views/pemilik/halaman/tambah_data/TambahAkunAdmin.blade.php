            ...
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <form class="contact-form-area contact-page-form contact-form text-left" action="{{url('AksiTambahAkunAdmin')}}" method="post">
                    ...
                    <div class="form-group">
                      <label>Foto</label>
                      <input type="password" class="form-control" name="foto" placeholder="Masukkan Foto">
                    </div>
                    <div class="form-group">
                      <label>Level</label>
